#!/usr/bin/env python3
"""Verify that the bankstatementparser-writer-xlsx package version is in lockstep everywhere.

Single source of truth: ``bankstatementparser_writer_xlsx.__version__``. This script reads
...
def _package_version() -> str:
    ...
    return bankstatementparser_writer_xlsx.__version__
...
def main() -> int:
    ...
    print(f"  bankstatementparser_writer_xlsx.__version__   = {pkg}")
